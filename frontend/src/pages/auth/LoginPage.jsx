...
const LoginPage = () => {
  ...
  const features = [
    {
      icon: <Activity className="f-icon" />,
      text: "Suivi des sprints en temps réel",
    },
      ...
      <div className="login-container">
        ...
        >
          <div className="login-logo-wrapper">
            <img
              src="/logo_clinisys_seullement.PNG"
              alt="Logo"
              className="login-main-logo"
            />
            <div className="login-brand-text">
              <span className="brand-clini">CLINI</span>
          ...
          <p className="login-hero-desc">
            Une plateforme dédiée à la gestion des stages et au suivi des
            performances.
          </p>
        ...
        >
          <div className="login-card">
            ...
            <div className="login-help">
              <p>
                Besoin d'aide ?{" "}
                <Link to="/contact">Contactez l'administrateur</Link>
              </p>
            </div>
          </div>
        </motion.div>
